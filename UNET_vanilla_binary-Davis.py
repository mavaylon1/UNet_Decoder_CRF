...
model.train(
    train_images = "/home/maavaylon/proximal_lower_contrast_train_renamed/imgs/",
    train_annotations = "/home/maavaylon/proximal_lower_contrast_train_renamed/DB_ann/",
    epochs=20,
    steps_per_epoch=len(glob("/home/maavaylon/proximal_lower_contrast_train_renamed/imgs/*")),
    batch_size=1,
    validate=True,
    val_images="/home/maavaylon/proximal_lower_contrast_val_renamed/img/",
    val_annotations="/home/maavaylon/proximal_lower_contrast_val_renamed/DB_ann_val/",
    val_batch_size=1,
    val_steps_per_epoch=len(glob("/home/maavaylon/proximal_lower_contrast_val_renamed/img/*"))
)
