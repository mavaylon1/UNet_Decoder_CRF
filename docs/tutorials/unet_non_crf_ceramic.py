...
model.train(
    train_images = "/home/maavaylon/ceramic_1280/halfres_original/",
    train_annotations = "/home/maavaylon/ceramic_1280/halfres_2labels_ground/",
    epochs=10000,
    steps_per_epoch=len(glob("/home/maavaylon/ceramic_1280/halfres_original/*")),
    batch_size=1)
