...
model.load_weights('/global/homes/m/mavaylon/PM_UNET/UNet_Decoder_CRF/docs/tutorials/unet_crf_half_fiber_6_7_8.h5')

model.train(
    train_images = "/pscratch/sd/m/mavaylon/Fiber/Half/first/img/",
    train_annotations = "/pscratch/sd/m/mavaylon/Fiber/Half/first/ann/",
    epochs=10,
    data_size='half_9_10_11',
    steps_per_epoch=len(glob("/pscratch/sd/m/mavaylon/Fiber/Half/first/img/*")),
    batch_size=1,
    verify_dataset=False,
    do_augment=True,
    validate=True,
    val_images="/pscratch/sd/m/mavaylon/Fiber/Half/Val/half/img/",
    val_annotations="/pscratch/sd/m/mavaylon/Fiber/Half/Val/half/ann/",
    val_batch_size=1,
    val_steps_per_epoch=len(glob("/pscratch/sd/m/mavaylon/Fiber/Half/Val/half/img/*"))
)
