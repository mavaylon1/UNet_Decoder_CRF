...
model.load_weights('/Users/mavaylon/Research/pet_weights/VGG_VANILLA_PET/pet_class_crf.h5')

# Predictions
img_names = sorted(glob("/Users/mavaylon/Research/pet_predictions/img/*.png"))

for name in img_names:
    out_name = "/Users/mavaylon/Research/CNN_CRF/test_pred_repo/VGG_PET/" + name.split('/')[-1]
    print(out_name)
